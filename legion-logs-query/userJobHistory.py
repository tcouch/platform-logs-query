...
class jobHistory(object):
    ...
    def constructQuery(self):
        ...
        print queryString #for testing purposes
        return queryString
    ...
    def processResult(self):
        ...
        print jobList #for testing purposes
##        userSummary = list()
...
##                    ldapcreds = filter(lambda ldapUserData: ldapUserData['userid'] == job['owner'], ldapData)
##                    dept = ldapcreds['department']
##                    sn = ldapcreds['sn']
##                    givenName = ldapcreds['givenName']
##                else:
...
def main():
    startDate = dt.datetime(2015,12,25)
...
#        "usernames": ["cceatco"]
    ...
    jobHistory(**kwargs).processResult()
